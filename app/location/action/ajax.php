...
switch($ts){
	case "join":
		...
		if($userid==0){
			getJson('Пожалуйста, войдите и зарегистрируйтесь снова!');
		}

		//ts_article、ts_attach、ts_group_topic、ts_photo、ts_user_info、ts_weibo
	...
	case "exit":
		...
		getJson('Вы успешно вышли!',1,2,tsUrl('location'));
